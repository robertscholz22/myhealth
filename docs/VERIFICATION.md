...
- NOTE-21: the review/Today chips still derive max HR from the age formula (Z1 ends at 127) while Zones & paces also uses the highest observed HR of the last year (133); pass the observed max too for a perfect match.

 ...
 * a search field over [ExerciseCatalog] (name and muscle names both match) and a tappable list.
 * Self-contained like `LinkActivitySheet` — its query is local, ephemeral form state, not part of
 * [WorkoutEditUiState].
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun ExercisePickerSheet(onPick: (Exercise) -> Unit, onDismiss: () -> Unit, modifier: Modifier = Modifier) {

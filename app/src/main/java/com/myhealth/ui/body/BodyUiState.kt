...
/**
 * ViewModel state for [BodyScreen] (§4.2 Body & Health v1: latest weight card, goal delta,
 * "Log weight" dialog, plain 90-day list — no charts yet, those land in P8.3).
 */
data class BodyUiState(
    val isLoading: Boolean = true,
    val goalWeightKg: Double? = null,
    /** Last 90 days, most recent first — see [sortedByRecencyDescending]. */
